...
class SettingsAction extends _$SettingsAction {
  static Serializer<SettingsAction> get serializer =>
  ...
  SettingsAction.selectCardSharedIndex(
      NodeName nodeName, IndexServerFile indexServerFile)
      : super.selectCardSharedIndex(nodeName, indexServerFile);
  SettingsAction.selectCardSharedRelay(
      NodeName nodeName, RelayAddress relayAddress)
      : super.selectCardSharedRelay(nodeName, relayAddress);
  SettingsAction.selectCardSharedFriend(
      NodeName nodeName, FriendFile friendFile)
...
class CardSettingsAction extends _$CardSettingsAction {
  static Serializer<CardSettingsAction> get serializer =>
  ...
  CardSettingsAction.friendsSettings(FriendsSettingsAction friendsSettings)
      : super.friendsSettings(friendsSettings);
  CardSettingsAction.relaysSettings(RelaysSettingsAction relaysSettings)
      : super.relaysSettings(relaysSettings);
  CardSettingsAction.indexServersSettings(
      IndexServersSettingsAction indexServersSettings)
      : super.indexServersSettings(indexServersSettings);
}

@BuiltUnion()
class FriendsSettingsAction extends _$FriendsSettingsAction {
  static Serializer<FriendsSettingsAction> get serializer =>
  ...
  FriendsSettingsAction.newFriend(NewFriendAction newFriend)
...
class NewFriendAction extends _$NewFriendAction {
  static Serializer<NewFriendAction> get serializer =>
      _$newFriendActionSerializer;

  NewFriendAction.back() : super.back();
  NewFriendAction.loadFriend(FriendFile friendFile)
      : super.loadFriend(friendFile);
  NewFriendAction.addFriend(String friendName, FriendFile friendFile)
      : super.addFriend(friendName, friendFile);
}

@BuiltUnion()
class FriendSettingsAction extends _$FriendSettingsAction {
  static Serializer<FriendSettingsAction> get serializer =>
  ...
  FriendSettingsAction.removeCurrency(Currency currency)
      : super.removeCurrency(currency);

  FriendSettingsAction.selectNewCurrency() : super.selectNewCurrency();
  FriendSettingsAction.newCurrency(
      Currency currency, U128 remoteMaxDebt, Rate rate)
      : super.newCurrency(currency, remoteMaxDebt, rate);

  FriendSettingsAction.selectCurrency(Currency currency)
      : super.selectCurrency(currency);
  FriendSettingsAction.openCurrency(Currency currency)
      : super.openCurrency(currency);
  FriendSettingsAction.closeCurrency(Currency currency)
      : super.closeCurrency(currency);
  FriendSettingsAction.updateCurrency(
      Currency currency, U128 remoteMaxDebt, Rate rate)
...
class RelaysSettingsAction extends _$RelaysSettingsAction {
  static Serializer<RelaysSettingsAction> get serializer =>
      _$relaysSettingsActionSerializer;

  RelaysSettingsAction.back() : super.back();
  RelaysSettingsAction.removeRelay(PublicKey relayPublicKey)
      : super.removeRelay(relayPublicKey);
  RelaysSettingsAction.selectNewRelay() : super.selectNewRelay();
  RelaysSettingsAction.loadRelay(RelayAddress relayAddress)
...
class IndexServersSettingsAction extends _$IndexServersSettingsAction {
  static Serializer<IndexServersSettingsAction> get serializer =>
      _$indexServersSettingsActionSerializer;

  IndexServersSettingsAction.back() : super.back();
  IndexServersSettingsAction.removeIndex(PublicKey indexPublicKey)
      : super.removeIndex(indexPublicKey);
  IndexServersSettingsAction.selectNewIndex() : super.selectNewIndex();
  IndexServersSettingsAction.loadIndexServer(IndexServerFile indexServerFile)
