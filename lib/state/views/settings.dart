...
class SettingsView extends _$SettingsView {
  ...
  SettingsView.cardSettings(CardSettingsView cardSettings)
      : super.cardSettings(cardSettings);
  SettingsView.newCard(NewCardView newCard) : super.newCard(newCard);
  SettingsView.selectCardAddRelay(RelayAddress relayAddress)
      : super.selectCardAddRelay(relayAddress);
  SettingsView.selectCardAddIndex(IndexServerFile indexServerFile)
      : super.selectCardAddIndex(indexServerFile);
  SettingsView.selectCardAddFriend(FriendFile friendFile)
...
class NewCardView extends _$NewCardView {
  ...
  NewCardView.newRemoteName(RemoteCardFile remoteCardFile)
...
abstract class CardSettingsView
  ...
  static Serializer<CardSettingsView> get serializer =>
...
class CardSettingsInnerView extends _$CardSettingsInnerView {
  static Serializer<CardSettingsInnerView> get serializer =>
      _$cardSettingsInnerViewSerializer;

  CardSettingsInnerView.home() : super.home();
  CardSettingsInnerView.friends(FriendsSettingsView friends)
      : super.friends(friends);
  CardSettingsInnerView.relays(RelaysSettingsView relays)
      : super.relays(relays);
  CardSettingsInnerView.indexServers(IndexServersSettingsView indexServers)
...
class FriendsSettingsView extends _$FriendsSettingsView {
  static Serializer<FriendsSettingsView> get serializer =>
      _$friendsSettingsViewSerializer;

  FriendsSettingsView.home() : super.home();
  FriendsSettingsView.friendSettings(FriendSettingsView friendSettings)
      : super.friendSettings(friendSettings);
  FriendsSettingsView.newFriend(NewFriendView newFriend)
...
abstract class FriendSettingsView
  ...
  static Serializer<FriendSettingsView> get serializer =>
...
class FriendSettingsInnerView extends _$FriendSettingsInnerView {
  static Serializer<FriendSettingsInnerView> get serializer =>
...
class IndexServersSettingsView extends _$IndexServersSettingsView {
  static Serializer<IndexServersSettingsView> get serializer =>
  ...
  IndexServersSettingsView.newIndexName(IndexServerFile indexServerFile)
